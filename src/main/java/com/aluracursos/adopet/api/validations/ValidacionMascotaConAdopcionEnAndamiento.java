...
public class ValidacionMascotaConAdopcionEnAndamiento implements ValidacionesSolicitudAdopcion{
    ...
    public void validar(SolicitudAdopcionDTO dto) {
        boolean mascotaTieneAdopcionEnAndamiento = adopcionRepository.
                existsByMascotaIdAndStatus(dto.idMascota(), StatusAdopcion.ESPERANDO_EVALUACION);
        if (mascotaTieneAdopcionEnAndamiento) {
